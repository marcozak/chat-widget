...
<template>
    ...
    >
        <div v-if="!open" class="absolute bottom-3 right-4 bg-black border-gray-dark border-8 rounded-full w-20 h-20 flex justify-center items-center">
    ...
    >
        <div v-if="open" class="flex flex-col justify-between items-center fixed bottom-0 right-0 md:bottom-1 md:right-4 w-screen h-screen md:w-[375px] md:max-h-[95dvh] md:h-[min(880px,95dvh)]">
            ...
            <div v-if="displayMenu" class="absolute z-10 top-0 w-screen h-screen md:w-[375px] md:max-h-[95dvh] md:h-[min(880px,95dvh)] bg-gray-dark md:rounded-2xl">
                <Menu 
